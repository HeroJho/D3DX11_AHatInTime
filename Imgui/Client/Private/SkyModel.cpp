...
HRESULT CSkyModel::Render()
{
	...
	_bool bTemp = false;
	if (FAILED(m_pShaderCom->Set_RawValue("g_IsPicked", &bTemp, sizeof(_bool))))
		return E_FAIL;
...
HRESULT CSkyModel::Ready_Components()
{
	...
	/* For.Com_Model */
	if (FAILED(__super::Add_Component(LEVEL_GAMEPLAY, TEXT("Prototype_Component_Sky"), TEXT("Com_Model"), (CComponent**)&m_pModelCom)))
		return E_FAIL;

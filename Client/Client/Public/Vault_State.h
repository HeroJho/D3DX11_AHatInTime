...
class CVault_State final : public CItem
{
public:
...
private:
	CVault_State(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CVault_State(const CVault_State& rhs);
	virtual ~CVault_State() = default;
...
public:
	static CVault_State* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);

...
class CVault_2 final : public CItem
{
public:
...
private:
	CVault_2(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CVault_2(const CVault_2& rhs);
	virtual ~CVault_2() = default;
...
public:
	static CVault_2* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);

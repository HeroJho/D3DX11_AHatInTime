...
class CStatuePosed final : public CMonster
{
public:
...
private:
	CStatuePosed(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CStatuePosed(const CStatuePosed& rhs);
	virtual ~CStatuePosed() = default;
...
public:
	static CStatuePosed* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);

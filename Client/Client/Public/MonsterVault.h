...
class CMonsterVault final : public CItem
{
public:
...
private:
	CMonsterVault(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CMonsterVault(const CMonsterVault& rhs);
	virtual ~CMonsterVault() = default;
...
public:
	static CMonsterVault* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);

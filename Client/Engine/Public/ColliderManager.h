...
public:
	enum COLLIDERGROUP { COLLIDER_PLAYER, COLLIDER_MONSTER, COLLIDER_PUSHMONSTER, COLLIDER_NPC, COLLIDER_SWORD, COLLIDER_ITEM, COLLIDER_EM, COLLIDER_PROJECT, COLLIDER_END };
